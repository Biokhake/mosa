...
function helm(): Spec[] {
  ...
  return [
    B("prim", 0.132, 0.108, 0.14, 0, 0.004, -0.012),
    Trap("prim", 0.094, 0.132, 0.024, 0, 0.068, -0.012, 0, 0, 0, 0.132),
    // the raised block on the crown centreline
    B("prim", 0.044, 0.018, 0.055, 0, 0.09, 0.005),
    // brow shelf the crest hub seats against
    B("prim", 0.106, 0.024, 0.044, 0, 0.047, 0.056),
    Trap("prim", 0.09, 0.122, 0.066, 0, -0.006, -0.076, -0.1, 0, 0, 0.048),
  ];
}
...
function visorMask(): Spec[] {
  ...
  return [
    B("dark", 0.088, 0.108, 0.026, 0, -0.001, 0),
    B("dark", 0.09, 0.013, 0.032, 0, 0.043, 0.004),
    // centre ridge: brow to chin
    Wedge("prim", 0.02, 0.07, 0.026, 0, -0.01, 0.017),
    // projecting chin block at the base of the ridge
    Trap("prim", 0.028, 0.022, 0.026, 0, -0.046, 0.019, 0, 0, 0, 0.028),
  ];
}
...
function ear(): Spec[] {
  ...
  return [
    B("prim", 0.018, 0.06, 0.072, 0, -0.004, -0.008),
...
function cheek(): Spec[] {
  ...
  return [
    B("prim", 0.022, 0.066, 0.046, 0, 0.004, -0.004),
...
function chin(): Spec[] {
  ...
  return [
    Trap("prim", 0.062, 0.098, 0.054, 0, -0.002, -0.015, 0.2, 0, 0, 0.056),
...
function jaw(): Spec[] {
  ...
  return [
    B("prim", 0.084, 0.032, 0.08, 0, 0.006, -0.005),
    C("dark", 0.034, 0.036, 0.034, 0, -0.02, -0.02, 0, 0, 0, 10),
  ];
}
...
function collar(): Spec[] {
  ...
  return [
    // The column has to span its socket to the chin — the derived frame puts
    // those 0.115 apart, and a 0.094 column left the head floating.
    C("dark", 0.032, 0.036, 0.125, 0, 0.055, -0.01, 0, 0, 0, 12),
    Torus("joint", 0.038, 0.009, 0, 0.104, -0.01, PI2, 0, 0, 14),
...
function chestCore(): Spec[] {
  return [
    B("prim", 0.212, 0.165, 0.185, 0, 0.0, -0.015),
    // upper chest, wider and pitched forward over the abdomen
    Trap("prim", 0.262, 0.212, 0.075, 0, 0.058, 0.01, 0, 0, 0, 0.175),
...
function chest(): Spec[] {
  return [
    B("sec", 0.072, 0.15, 0.155, -0.008, 0.005, 0),
    Trap("sec", 0.05, 0.072, 0.042, -0.008, 0.082, 0.005, 0, 0, 0, 0.145),
...
function abdomen(): Spec[] {
  return [
    C("dark", 0.06, 0.066, 0.055, 0, 0.055, -0.012, 0, 0, 0, 12),
    B("prim", 0.215, 0.105, 0.15, 0, -0.025, -0.012),
    B("acc", 0.05, 0.05, 0.028, 0, -0.02, 0.058),
    B("trim", 0.175, 0.014, 0.022, 0, -0.072, 0.055),
  ];
}
...
function skirtF(): Spec[] {
  ...
  return [
    B("prim", 0.2, 0.128, 0.055, 0, -0.048, 0, 0.1),
    ...
    Trap("prim", 0.16, 0.2, 0.028, 0, -0.114, 0.004, 0.1, 0, 0, 0.05),
  ];
}
...
function skirtSide(): Spec[] {
  ...
  return [
    B("prim", 0.05, 0.125, 0.115, 0.014, -0.046, -0.005, 0, 0, -0.08),
...
function forearm(): Spec[] {
  ...
  return [
    C("joint", 0.036, 0.036, 0.07, 0, 0.16, 0, 0, 0, PI2, 12),
    B("dark", 0.06, 0.056, 0.072, 0, 0.16, 0),
    B("prim", 0.072, 0.2, 0.082, 0, 0.02, 0),
    Trap("prim", 0.068, 0.085, 0.05, 0, -0.1, 0, 0, 0, 0, 0.088),
    B("prim", 0.032, 0.155, 0.082, 0.044, 0.025, 0),
    B("trim", 0.013, 0.032, 0.048, 0.05, 0.082, 0.005),
...
function foot(): Spec[] {
  ...
  return [
    B("prim", 0.155, 0.062, 0.19, 0, 0.022, 0.025),
    Wedge("prim", 0.145, 0.055, 0.06, 0, 0.018, 0.14),
    B("dark", 0.155, 0.024, 0.19, 0, -0.014, 0.025),
    Trap("prim", 0.095, 0.13, 0.055, 0, 0.025, -0.082, 0, 0, 0, 0.055),
