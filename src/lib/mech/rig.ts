...
export const NODE_ROM: Record<RigNodeId, NodeRom> = {
  ...
  shoulderR: { rx: [-95, 180], ry: [-95, 95], rz: [-125, 35] },
  elbowR: { rx: [-150, 3], ry: [-4, 4], rz: [-4, 4] },
  wristR: { rx: [-55, 55], ry: [-35, 35], rz: [-25, 25] },
  shoulderL: { rx: [-95, 180], ry: [-95, 95], rz: [-35, 125] },
  elbowL: { rx: [-150, 3], ry: [-4, 4], rz: [-4, 4] },
  wristL: { rx: [-55, 55], ry: [-35, 35], rz: [-25, 25] },
  hipR: { rx: [-125, 40], ry: [-35, 45], rz: [-42, 25] },
  kneeR: { rx: [-3, 155], ry: [-3, 3], rz: [-3, 3] },
  ankleR: { rx: [-40, 45], ry: [-8, 8], rz: [-22, 22] },
  hipL: { rx: [-125, 40], ry: [-45, 35], rz: [-25, 42] },
